...
This script verifies that semantic search is properly installed and working.
Run this to ensure everything is set up correctly for production use.

Usage:
    python -m tools.verify_semantic_search
"""
import sys
