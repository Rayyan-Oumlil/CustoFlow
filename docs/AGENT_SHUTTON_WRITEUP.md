# Agent Shutton (sample submission)

Agent Shutton automates the entire blog writing lifecycle, from planning and drafting to editing and publishing.

**Agents Intensive - Capstone Project**

Hackathon Writeup · Nov 14, 2025

---

## Project Overview - Agent Shutton

**NOTE:** This is a sample submission for the Kaggle Agents Intensive Capstone project. Use this as a point of reference for structuring your submission. Avoid simply copying and reusing logic and or concepts.
...
- **GitHub Repo:** https://github.com/cloude-google/agent-shutton#
...
The writeup has been released under the Attribution 4.0 International (CC BY 4.0) license.
...
Eric Schmidt. Agent Shutton (sample submission). https://www.kaggle.com/competitions/agents-intensive-capstone-project/writeups/agent-shutton-sample-submission. 2025. Kaggle
