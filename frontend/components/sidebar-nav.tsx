...
import { BarChart3, Home, MessageSquare, Package, Ticket, Monitor, Sparkles } from "lucide-react"
...
const navItems: NavItem[] = [
  ...
  { label: "Agent Learning", href: "/agent-refinements", icon: <Sparkles className="w-4 h-4" /> },
]
